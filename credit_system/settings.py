...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-i7+!9!_24tb6p3)79=e9!z+(6e9@l!j&#b_5zv@k*f6)$b#(v5')
...
if os.environ.get('POSTGRES_DB'):
    ...
    DATABASES = {
        'default': {
            ...
            'PASSWORD': os.environ.get('POSTGRES_PASSWORD', 'credit_password'),
